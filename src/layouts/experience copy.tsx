...
import CLSU from "../assets/images/logo/clsu.png";
    ...
    >
      <Container maxWidth="lg">
        <Stack gap={2}>
          ...
          {MyExperiences.map(({ title, experiences }, idx) => {
            return (
              <Stack key={title} gap={2} sx={{ width: "100%" }}>
                <Typography
                  fontSize={24}
                  fontWeight={700}
                  textTransform={"uppercase"}
